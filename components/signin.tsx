  ...
  return (
	...
	style={{ backgroundImage: 'url("/background.jpg")' }}>
      ...
      <Image
        ...
        width={280}
        height={160}
        className="w-[200px] h-[100px]  lg:w-[161px] lg:h-[73px]"
        priority
      />
    </Link>
        ...
        <button
          disabled={loading}
          className="w-full flex items-center justify-center gap-2 bg-black py-2 lg:py-3 text-white text-sm lg:text-lg font-medium rounded-lg shadow-lg transition-transform transform hover:scale-105 disabled:opacity-50"
          type="submit"
        >
      ...
      >
        <div className=" lg:mx-5   flex flex-row gap-x-3 lg:gap-x-5">
       ...
       <p className="lg:mx-5 mt-2 lg:mt-2 text-sm"> Sign in with Google </p>
        </div>
      </button>
